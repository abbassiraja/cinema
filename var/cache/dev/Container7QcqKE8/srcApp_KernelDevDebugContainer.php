...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('BkxSbctq-M', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QjbJpnseSj', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AbJCfc8w-A', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jXZyqQ8KzT', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YV5YDAfF2R', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QhJCR32I3g', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('r+7UFgB0Ha', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder063bc = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializeraad8e = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesee208 = [
        
    ];

    public function getConnection()
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'getConnection', array(), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'getMetadataFactory', array(), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'getExpressionBuilder', array(), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'beginTransaction', array(), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->beginTransaction();
    }

    public function getCache()
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'getCache', array(), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->getCache();
    }

    public function transactional($func)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'transactional', array('func' => $func), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->transactional($func);
    }

    public function commit()
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'commit', array(), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->commit();
    }

    public function rollback()
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'rollback', array(), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'getClassMetadata', array('className' => $className), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'createQuery', array('dql' => $dql), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'createNamedQuery', array('name' => $name), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'createQueryBuilder', array(), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'flush', array('entity' => $entity), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'clear', array('entityName' => $entityName), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->clear($entityName);
    }

    public function close()
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'close', array(), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->close();
    }

    public function persist($entity)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'persist', array('entity' => $entity), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'remove', array('entity' => $entity), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'refresh', array('entity' => $entity), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'detach', array('entity' => $entity), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'merge', array('entity' => $entity), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'getRepository', array('entityName' => $entityName), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'contains', array('entity' => $entity), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'getEventManager', array(), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'getConfiguration', array(), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'isOpen', array(), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'getUnitOfWork', array(), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'getProxyFactory', array(), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'initializeObject', array('obj' => $obj), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'getFilters', array(), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'isFiltersStateClean', array(), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'hasFilters', array(), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return $this->valueHolder063bc->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializeraad8e = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder063bc) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder063bc = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder063bc->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, '__get', ['name' => $name], $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        if (isset(self::$publicPropertiesee208[$name])) {
            return $this->valueHolder063bc->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder063bc;
    ...
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, '__set', array('name' => $name, 'value' => $value), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;
    ...
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, '__isset', array('name' => $name), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;
    ...
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, '__unset', array('name' => $name), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;
    ...
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, '__clone', array(), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        $this->valueHolder063bc = clone $this->valueHolder063bc;
    }

    public function __sleep()
    {
        $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, '__sleep', array(), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;

        return array('valueHolder063bc');
    }
    ...
    {
        $this->initializeraad8e = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializeraad8e;
    }

    public function initializeProxy() : bool
    {
        return $this->initializeraad8e && ($this->initializeraad8e->__invoke($valueHolder063bc, $this, 'initializeProxy', array(), $this->initializeraad8e) || 1) && $this->valueHolder063bc = $valueHolder063bc;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder063bc;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder063bc;
    }
}
